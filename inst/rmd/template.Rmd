...
# To create such a dataframe, follow the example in the README file.
# Make sure the name of the data frame is 'df'and add '## @knitr prepareData' 
...
results <- neatmap(df, scale.df = "basic", mainTitle = "",
                   ...
                   link.method = "single", xlabCex = 4, nBootRep = 1000)
```
<div align="center">
```{r echo=FALSE}
...
results <- neatmap(df, scale.df = "basic", mainTitle = "",
                   xlabel = "Chararacteritics", ylabel = "Networks",
                   link.method = "average", xlabCex = 4, nBootRep = 1000)
```
<div align="center">
```{r echo=FALSE}
suppressWarnings(results[[4]] %>% layout(margin = list(b = 150), width = 800, height = 650))
...
results <- neatmap(df, scale.df = "basic", mainTitle = "",
                   xlabel = "Chararacteritics", ylabel = "Networks",
                   link.method = "complete", xlabCex = 4, nBootRep = 1000)
```
<div align="center">
```{r echo=FALSE}
suppressWarnings(results[[4]] %>% layout(margin = list(b = 150), width = 800, height = 650))
